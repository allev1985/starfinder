...
#### Scenario: Shield Total includes misc modifier
- **WHEN** the user enters a value in the Misc Mod field
- **THEN** the Shield Total immediately reflects the new sum including the misc mod
